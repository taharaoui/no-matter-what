...
export default function Philosophy() {
  ...
  return (
    <section ref={ref} className="relative bg-sage-deep text-paper-light py-32 md:py-40 grain overflow-hidden">
      <div className="relative mx-auto max-w-4xl px-6 md:px-10 text-center">
        <p className="reveal font-utility text-[11px] uppercase tracking-[0.2em] text-brass mb-8">
          Notre philosophie
        </p>
